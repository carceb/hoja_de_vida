...
class PersonalController extends Controller
{
	...
	public function actionIndex()
	{
                ...
                {
                    $condicionCriterio='estado_id='.CHtml::encode(Yii::app()->user->first_name);
                }
                else
                {
                    $condicionCriterio='';
                ...
                $dataProvider=new CActiveDataProvider('Personal', array(
                    'criteria'=>array(
                        'condition'=>$condicionCriterio,//obtiene el id del estado del usuario ,mediante la clase WebUser
                    ),
                    'pagination'=>array(
                        'pageSize'=>10,
                    ),
	...
	{
		$model=Personal::model()->findByPk((int)$id);
		if($model===null)
